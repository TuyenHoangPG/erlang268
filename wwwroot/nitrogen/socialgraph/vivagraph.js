...
/*add*/
var VivaGraphZoom = new Object();
VivaGraphZoom.zoomInt = 0;
VivaGraphZoom.minInt = -10;
VivaGraphZoom.maxInt = 20;
    ...
    var prepareSettings = function () {
        ...
        listenToEvents = function () {
            ...
            containerDrag.onScroll(function (e, scaleOffset, scrollPoint) {
                ...
                VivaGraphZoom.zoomInt = (scaleFactor<1) ? VivaGraphZoom.zoomInt -1 :VivaGraphZoom.zoomInt + 1 ;
                if(VivaGraphZoom.zoomInt >= VivaGraphZoom.minInt && VivaGraphZoom.zoomInt <= VivaGraphZoom.maxInt)
                {
                ...
                {
                    if(VivaGraphZoom.zoomInt <= VivaGraphZoom.minInt)
                    {
                        VivaGraphZoom.zoomInt = VivaGraphZoom.minInt;
                    }
                    else if(VivaGraphZoom.zoomInt >= VivaGraphZoom.maxInt)
                    {
                        VivaGraphZoom.zoomInt = VivaGraphZoom.maxInt;
                    }
                }
            });
