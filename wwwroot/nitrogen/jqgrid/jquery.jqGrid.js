...
$.jgrid.extend({
    ...
    // This function added by Mr Ohta
    delLocalRow : function(rowid) {
...
"use strict";
    ...
    $.fn.fmatter.email = function(cellval, opts) {
        if(!$.fmatter.isEmpty(cellval)) {
            cellval = $.jgrid.htmlEncode(cellval);
    ...
    $.fn.fmatter.checkbox =function(cval, opts) {
        ...
        return "<input type=\"checkbox\" " + bchk  + " value=\""+ cval+"\" offval=\"no\" "+ds+ "/>"+label;
    };
        ...
        if (editable==="1") {
            ...
            if (cv[0] === false){
                try {
                    ...
                    var perHeight = $('#'+elemid).closest('tr').outerHeight(true);
